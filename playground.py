...
def getFilenameParameter() :
  ...
  if len(sys.argv) > 1 :
    ...
    numBalls = type(int(sys.argv[2]))
  else :
    print("Usage:", sys.argv[0], " <PlayGround Filename>");
    printPlayground()
    print()
    print("Non\t\t",sign_non)
...
def main() :
  ...
  for i in range (numBalls) :
    ...
    if storeBall :
      ...
      if True == playBall.wasL() :
        playBall = getRightBlueBall()
      else :
        playBall = getLeftRedBall()
